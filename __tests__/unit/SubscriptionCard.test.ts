import {convertCentToDollarString , convertByteToGigaByteString } from '../../src/components/SubscriptionCard/SubscriptionCard';
...
describe('Test functions in SubscriptionCard',()=>{
  describe('convertCentToDollarString',()=>{
    it('Price is data',()=>{
      ...
      expect(convertCentToDollarString(data)).toEqual(`${data / 100} USD in a month`)
    })
    it('Price is Free',()=>{
      const data:number = 0;
